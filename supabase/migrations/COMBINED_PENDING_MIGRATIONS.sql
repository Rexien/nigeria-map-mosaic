-- ====================================================================
-- NIAC LIVE 2026: CONSOLIDATED PENDING MIGRATIONS
-- Apply this file in your Supabase SQL Editor:
-- https://supabase.com/dashboard/project/ptgrcseudavkaviwdgzo/sql/new
-- ====================================================================

-- --------------------------------------------------------------------
-- 1. Snapshot Scoring & High-Capacity Ingress (202609140001)
-- --------------------------------------------------------------------
...
-- --------------------------------------------------------------------
-- 2. Question Media & Decode Clues (202609170001)
-- --------------------------------------------------------------------
...
-- --------------------------------------------------------------------
-- 3. Projector Screen Mode (202609180001)
-- --------------------------------------------------------------------
alter table public.event_settings
  add column if not exists screen_mode text not null default 'welcome';

alter table public.event_settings
  drop constraint if exists event_settings_screen_mode_check;
