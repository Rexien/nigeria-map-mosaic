(function(){
  ...
  function applyAdminStatus(status){
    ...
    $$('[name="active-activity"]').forEach(input=>{if(input.value==='lobby')input.checked=isLobby;else input.checked=!isLobby&&input.value===activity});$('#quiz-controls').classList.toggle('hidden',isLobby||activity==='lens');
