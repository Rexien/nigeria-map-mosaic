...
module.exports = function() {
  ...
  cloud.initialBoard = function(_) {
    return arguments.length ? (initialBoard = _, cloud) : initialBoard;
  };

  cloud.start = function() {
    var contextAndRatio = getContext(canvas()),
        board = initialBoard ? (initialBoard instanceof Int32Array ? new Int32Array(initialBoard) : initialBoard.slice(0)) : zeroArray((size[0] >> 5) * size[1]),
        bounds = null,
        n = words.length,
        i = -1,
        tags = [],
