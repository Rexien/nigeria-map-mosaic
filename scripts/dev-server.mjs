...
async function api(req,res,url){
  ...
  if(path==='/answers'&&req.method==='POST'){
    ...
    const q=questions.find(x=>x.id===b.questionId),correct=b.optionIndex===q.correctOption,points=correct?(q.activity==='decode'?4-data.session.currentClue:1000):0;
