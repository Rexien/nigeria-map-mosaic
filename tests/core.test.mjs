...
test('decode scoring remains separate and decreases by clue',()=>{assert.deepEqual([1,2,3].map(clueNumber=>c.quizPoints({activity:'decode',correct:true,clueNumber})),[3,2,1])});
